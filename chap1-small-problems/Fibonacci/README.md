...
## fib3_with_type_hinting.py
Ref: http://ubuntuhandbook.org/index.php/2020/10/python-3-9-0-released-install-ppa-ubuntu/


In the above version of fib3 I took out the type hinting

```
#memo: Dict[int, int] 
memo = {0: 0, 1: 1}  # our base cases
```
to avoid these sorts of synyax errors
```
[~/projects/classic-problems-python/chap1-small-problems/Fibonacci] # python3 fib3_with_type_hinting.py
  File "fib3_with_type_hinting.py", line 4
    memo: Dict[int, int]  = {0: 0, 1: 1}  # our base cases
        ^
SyntaxError: invalid syntax
[~/projects/classic-problems-python/chap1-small-problems/Fibonacci] # python3 --version
Python 3.5.2
```

a better solution is to update to python3.9


```
[~/projects/classic-problems-python/chap1-small-problems/Fibonacci] # cat fib3_with_type_hinting.py
import time
from typing import Dict
...
[~/projects/classic-problems-python/chap1-small-problems/Fibonacci] # python3.9 fib3_with_type_hinting.py
55
--- 3e-05 seconds ---
6765
--- 1e-05 seconds ---
